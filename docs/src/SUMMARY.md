...
- [Generating Descriptors](./getting-started/generating-descriptors.md)

# Core Concepts

- [Queries, Mutations & Subscriptions](./core/operations.md)
...
- [Defining Entities](./federation/entities.md)
- [Entity Resolution](./federation/entity-resolution.md)
...
- [GBP+LZ4 Binary Protocol](./performance/gbp-compression.md)
