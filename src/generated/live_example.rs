...
pub struct UserStatus {
    ...
    #[prost(string, tag = "4")]
    pub current_activity: ::prost::alloc::string::String,
}
#[derive(Clone, PartialEq, ::prost::Message)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_user(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/live_example.UserService/GetUser",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("live_example.UserService", "GetUser"));
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/live_example.UserService/ListUsers",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("live_example.UserService", "ListUsers"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn get_user_status(
        ...
        ) -> std::result::Result<tonic::Response<super::UserStatus>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/live_example.UserService/GetUserStatus",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("live_example.UserService", "GetUserStatus"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn create_user(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/live_example.UserService/CreateUser",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("live_example.UserService", "CreateUser"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn update_user(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/live_example.UserService/UpdateUser",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("live_example.UserService", "UpdateUser"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/live_example.UserService/DeleteUser",
            );
            let mut req = request.into_request();
            req.extensions_mut()
...
pub mod user_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/live_example.UserService/GetUserStatus" => {
                    #[allow(non_camel_case_types)]
                    struct GetUserStatusSvc<T: UserService>(pub Arc<T>);
                    impl<
                        T: UserService,
                    > tonic::server::UnaryService<super::GetUserStatusRequest>
                    for GetUserStatusSvc<T> {
                        type Response = super::UserStatus;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UserService>::get_user_status(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "live_example.UserService";
